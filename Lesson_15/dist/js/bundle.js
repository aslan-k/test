...
function modal() {
  var overlay = document.querySelector(".overlay"),
      bindModal = function bindModal(btn, overlayStatus, overflowStatus) {
...
function timer() {
  ...
  var setClock = function setClock(id, endtime) {
    ...
    function updateClock() {
      ...
      t.hours < 10 ? hours.textContent = "0".concat(t.hours) : "";
      t.minutes < 10 ? minutes.textContent = "0".concat(t.minutes) : "";
      t.seconds < 10 ? seconds.textContent = "0".concat(t.seconds) : "";
...
/* harmony import */ var _parts_timer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./parts/timer.js */ "./src/js/parts/timer.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_parts_timer_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_parts_tabs_js__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
